...
export function ActionBar({
  ...
  const anyPending = isDialing || isSkipping || isNexting;
  ...
  return (
    <div className="flex items-center gap-2.5 px-5 py-2.5 bg-[var(--color-bg-primary)] border-b border-[var(--color-border)]">
      ...
      <button
        ...
        disabled={anyPending}
        className={cn(
          "flex items-center gap-1.5 rounded-lg px-[18px] py-[7px] text-[13px] font-semibold text-white cursor-pointer",
